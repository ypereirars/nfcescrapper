...
class InvoiceSchema(Schema):
    ...
    created_on = Column(DateTime, name="data_criacao", default=datetime.now(UTC))
    payment_type = Column(Text, name="tipo_pagamento")
    discounts = Column(Float, name="desconto")
    exchange = Column(Float, name="troco")
    total_before_discount = Column(Float, name="valor_total")
    total_after_discount = Column(Float, name="valor_a_pagar")
    total_items = Column(Float, name="quantidade_itens")
